...
public class WheelOptions4<T> {
    ...
    private OnOptionsSelectChangeListener4 optionsSelectChangeListener;
    ...
    public WheelOptions4(View view, boolean isRestoreItem) {
        super();
    ...
    public void setPicker(List<T> options1Items,
        ...
        wheelListener_option3 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (mOptions4Items != null) {
                    int opt4 = 0;
                    if (!isRestoreItem) {
                        opt4 = wv_option4.getCurrentItem() ;
                    }
                    wv_option4.setAdapter(new ArrayWheelAdapter(mOptions4Items.get(wv_option1.getCurrentItem())
                            .get(wv_option2.getCurrentItem()).get(wv_option3.getCurrentItem())));
        ...
        if (options3Items != null && linkage) {
            wv_option2.setOnItemSelectedListener(wheelListener_option3);
        }
    ...
    public int[] getCurrentItems() {
        ...
        if (mOptions4Items != null && mOptions4Items.size() > 0) {//非空判断
            currentItems[3] = wv_option4.getCurrentItem() > (mOptions4Items.get(currentItems[0]).get(currentItems[1]).get(currentItems[2]).size() - 1) ?
                    0 : wv_option4.getCurrentItem();
        } else {
    ...
    public void setOptionsSelectChangeListener(OnOptionsSelectChangeListener4 optionsSelectChangeListener) {
