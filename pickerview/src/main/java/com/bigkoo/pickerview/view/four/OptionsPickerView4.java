 ...
 */
public class OptionsPickerView4<T> extends BasePickerView implements View.OnClickListener {

    private WheelOptions4 wheelOptions;

    private static final String TAG_SUBMIT = "submit";
    private static final String TAG_CANCEL = "cancel";


    public OptionsPickerView4(PickerOptions pickerOptions) {
    ...
    private void initView(Context context) {
        ...
        wheelOptions = new WheelOptions4(optionsPicker, mPickerOptions.isRestoreItem);
        if (mPickerOptions.optionsSelectChangeListener4 != null) {
            wheelOptions.setOptionsSelectChangeListener(mPickerOptions.optionsSelectChangeListener4);
        }
    ...
    public void returnData() {
        if (mPickerOptions.optionsSelectListener4 != null) {
            int[] optionsCurrentItems = wheelOptions.getCurrentItems();
            mPickerOptions.optionsSelectListener4.onOptionsSelect(optionsCurrentItems[0], optionsCurrentItems[1],
                    optionsCurrentItems[2], optionsCurrentItems[3], clickView);
        }
    }
