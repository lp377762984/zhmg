...
public class InstallUtil {
    ...
    private File file;//下载下来后文件的路径
    public static int UNKNOWN_CODE = 2018;

    public InstallUtil(Activity mAct, File file) {
        this.mAct = mAct;
        this.file = file;
    }
    ...
    private void startInstallN() {
        ...
        Uri apkUri = FileProvider.getUriForFile(mAct, BuildConfig.APPLICATION_ID + ".provider", file);
        Intent install = new Intent(Intent.ACTION_VIEW);
