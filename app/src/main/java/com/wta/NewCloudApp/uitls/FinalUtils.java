...
public class FinalUtils {
    ...
    public static final String REGISTER_PROTOCOL = BuildConfig.APP_DOMAIN + "/htmlProtocol";

    public static final String ABOUT_US = BuildConfig.APP_DOMAIN + "/about";
    public static final String BUSINESS_PROTOCOL = BuildConfig.APP_DOMAIN + "/htmlAdmission";
